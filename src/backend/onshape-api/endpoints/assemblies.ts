...
export function getAssembly(
  ...
  return client.get(apiPath("assemblies", assemblyPath, toElementApiPath), {
    query: new URLSearchParams({
      ...
      includeMateConnectors: String(options.includeMateConnectors ?? false),
    }),
  });
}
...
export function getAssemblyFeatures(
  ...
  return client.get(
    ...
    {
      query: new URLSearchParams(featureIds.map((id) => ["featureId", id])),
    },
  );
}
...
export function createAssembly(
  ...
  return client.post(apiPath("assemblies", workspacePath, toInstanceApiPath), {
