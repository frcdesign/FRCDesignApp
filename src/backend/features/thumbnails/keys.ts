...
interface ThumbnailUrlOptions {
    ...
    /**
     * The insertable to render a miss from, for a surface the configuration
     * was picked on; absent serves what is stored and starts nothing, or a
     * search would start a render per row.
     */
    insertableId?: string;
}
