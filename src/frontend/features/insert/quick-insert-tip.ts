...
/**
 * Points out the faster route once, after an insert that took nothing from
 * opening the menu: the same insert was one right-click away. Shown only once,
 * since someone who wants the menu should not be told off for using it.
 */
