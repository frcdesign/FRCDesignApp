CREATE TABLE `configuration_value_stats` (
	`library_id` text NOT NULL,
	`element_id` text NOT NULL,
	`parameter_id` text NOT NULL,
	`value` text NOT NULL,
	`count` integer DEFAULT 0 NOT NULL,
	PRIMARY KEY(`library_id`, `element_id`, `parameter_id`, `value`)
);
...
CREATE INDEX `events_element_day_idx` ON `events` (`library_id`,`element_id`,`day`);--> statement-breakpoint
