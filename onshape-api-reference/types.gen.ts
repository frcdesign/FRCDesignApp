...
export type BtAssemblyInstanceType =
    | "Assembly"
    | "Feature"
    | "Part"
    | "Unknown";
...
export type BtConfigurationResponse2019 = {
     ...
     */
    btType?: string;
    configurationParameters?: Array<BtmConfigurationParameter819Union>;
...
export type BtDocumentElementReference2484 = Omit<
...
export type BtElementGroup1458 = {
     ...
     */
    groups?: Array<BtGroupOrElementReference2205Union>;
    /**
...
export type BtEnumOptionVisibilityCondition3455 = {
     ...
     */
    btType?: string;
    condition?: BtParameterVisibilityCondition177Union;
};
...
export type BtEnumOptionVisibilityConditionList2936 = {
     ...
     */
    btType?: string;
    visibilityConditions?: Array<BtEnumOptionVisibilityCondition3455Union>;
};

export type BtEnumOptionVisibilityForList1613 = Omit<
...
export type BtEnumOptionVisibilityForRange4297 = Omit<
    BtEnumOptionVisibilityCondition3455,
    "btType"
> & {
...
export type BtGlobalTreeNodeSummaryInfo = Omit<
...
export type BtmConfigurationParameter819 = Omit<BtmNode19, "btType"> & {
    ...
    valid?: boolean;
    visibilityCondition?: BtParameterVisibilityCondition177Union;
} & {
    /**
     * Type of JSON object.
     */
...
export type BtmConfigurationParameterBoolean2550 = Omit<
...
export type BtmConfigurationParameterEnum105 = Omit<
    BtmConfigurationParameter819,
    "btType"
> & {
...
export type BtmConfigurationParameterQuantity1826 = Omit<
    BtmConfigurationParameter819,
    "btType"
> & {
...
export type BtmConfigurationParameterString872 = Omit<
    BtmConfigurationParameter819,
    "btType"
> & {
 ...
 */
export type BtMetadataStateType =
    | "IN_PROGRESS"
    | "PENDING"
    | "RELEASED"
    | "OBSOLETE"
...
export type BtParameterVisibilityAlwaysHidden176 = Omit<
...
export type BtParameterVisibilityAlwaysShown5487 = Omit<
    BtParameterVisibilityCondition177,
    "btType"
> & {
...
export type BtParameterVisibilityInRange2980 = Omit<
    BtParameterVisibilityCondition177,
    "btType"
> & {
...
export type BtParameterVisibilityLogical178 = Omit<
    BtParameterVisibilityCondition177,
    "btType"
> & {
    btType?: "BTParameterVisibilityLogical-178";
    children?: Array<BtParameterVisibilityCondition177Union>;
...
export type BtParameterVisibilityOnEqual180 = Omit<
    BtParameterVisibilityCondition177,
    "btType"
> & {
...
export type GbtConfigurationParameterType =
    | "ENUM"
    | "BOOLEAN"
    | "STRING"
    | "QUANTITY";

export type GbtElementType =
    | "PARTSTUDIO"
    | "ASSEMBLY"
    | "DRAWING"
    | "FEATURESTUDIO"
...
export type GbtpDefinitionType =
    | "FUNCTION"
    | "PREDICATE"
    | "CONSTANT"
    | "ENUM"
...
export type GbtParameterLibraryRelationType =
    | "DEFAULT"
...
export type BtmConfigurationParameter819Union =
...
export type BtParameterVisibilityCondition177Union =
...
export type BtEnumOptionVisibilityCondition3455Union =
    | BtEnumOptionVisibilityForList1613
    | BtEnumOptionVisibilityForRange4297;

export type BtGroupOrElementReference2205Union =
...
export type GetAssemblyDefinitionResponse =
    GetAssemblyDefinitionResponses[keyof GetAssemblyDefinitionResponses];
...
export type GetDocumentVersionsResponse =
    GetDocumentVersionsResponses[keyof GetDocumentVersionsResponses];
...
export type GetDocumentContentsResponse =
    GetDocumentContentsResponses[keyof GetDocumentContentsResponses];
...
export type DecodeConfigurationResponse =
    DecodeConfigurationResponses[keyof DecodeConfigurationResponses];
...
export type GetPartsWmveResponse =
    GetPartsWmveResponses[keyof GetPartsWmveResponses];
...
export type GetPartStudioFeaturesResponse =
    GetPartStudioFeaturesResponses[keyof GetPartStudioFeaturesResponses];
