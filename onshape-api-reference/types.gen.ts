...
export type ClientOptions = {
    baseUrl: 'https://cad.onshape.com/api/v17' | (string & {});
};
...
export type GbtpDefinitionType = 'FUNCTION' | 'PREDICATE' | 'CONSTANT' | 'ENUM' | 'USER_TYPE' | 'FEATURE_DEFINITION' | 'FILE_HEADER' | 'UNDOCUMENTABLE' | 'CONST_LAMBDA' | 'OPERATOR' | 'UNKNOWN';
...
export type BtmConfigurationParameter819Union = BtmConfigurationParameterBoolean2550 | BtmConfigurationParameterEnum105 | BtmConfigurationParameterQuantity1826 | BtmConfigurationParameterString872;

export type BtParameterVisibilityCondition177Union = BtParameterVisibilityAlwaysHidden176 | BtParameterVisibilityAlwaysShown5487 | BtParameterVisibilityInRange2980 | BtParameterVisibilityLogical178 | BtParameterVisibilityOnEqual180;

export type BtEnumOptionVisibilityCondition3455Union = BtEnumOptionVisibilityForList1613 | BtEnumOptionVisibilityForRange4297;

export type BtGroupOrElementReference2205Union = BtDocumentElementReference2484 | BtElementGroup1458;
